  ...
  return (
    <div className="bg-background1 flex flex-col justify-center items-center">
      <div className="text-center max-w-[80%]">
        <h1 className="text-background2 font-title font-bold text-6xl m-5">
          Contact
        </h1>
      </div>
      <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 gap-4">
        ...
        <div className="align-top text-center mx-auto">
          ...
          <p className="text-background2 font-body font-bold text-lg max-w-[80%] xl:max-w-[60%] mx-auto mt-5">
...
export default ContactInfoDark;
